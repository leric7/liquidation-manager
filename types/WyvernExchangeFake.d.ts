...
interface WyvernExchangeFakeInterface extends ethers.utils.Interface {
  functions: {
...
export class WyvernExchangeFake extends BaseContract {
  ...
  interface: WyvernExchangeFakeInterface;
